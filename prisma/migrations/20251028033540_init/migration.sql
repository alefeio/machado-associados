...
-- CreateIndex
CREATE UNIQUE INDEX "PacoteDate_pacoteId_saida_key" ON "PacoteDate"("pacoteId", "saida");
...
-- AddForeignKey
ALTER TABLE "Pacote" ADD CONSTRAINT "Pacote_destinoId_fkey" FOREIGN KEY ("destinoId") REFERENCES "Destino"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PacoteFoto" ADD CONSTRAINT "PacoteFoto_pacoteId_fkey" FOREIGN KEY ("pacoteId") REFERENCES "Pacote"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PacoteDate" ADD CONSTRAINT "PacoteDate_pacoteId_fkey" FOREIGN KEY ("pacoteId") REFERENCES "Pacote"("id") ON DELETE CASCADE ON UPDATE CASCADE;
