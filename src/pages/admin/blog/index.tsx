...
// 🌟 ALTERAÇÃO AQUI: Adicionar o campo slug
// Usamos o nome do modelo (Blog)
interface BlogItem {
    id: string;
    title: string;
    slug: string | null; // 🌟 NOVO: Adicionado para tipar o slug retornado pela API
...
                                            {/* 🌟 NOVO: Exibir o slug para o administrador */}
                                            <p className="text-sm text-blue-500 font-mono break-all">{post.slug || "⚠️ Slug Pendente"}</p>
